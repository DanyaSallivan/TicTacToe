...
def play():
    ...
    head = Button(menu, text="---Крестики Нолики---",
                  ...
                  fg="black", width=500, font='summer', bd=0)
    head.pack(anchor="n", padx=0, pady=[0,25])
    B1 = Button(menu, text="Против Компьютера", command=wpc,
                activeforeground='white',
                activebackground="green1", bg="green3",
                fg="white", width=500, font='summer', bd=5)
    B1.pack(anchor="center", padx=0, pady=0)
    B3 = Button(menu, text="Выход", command=menu.quit,
                activeforeground='white',
                activebackground="red", bg="red3",
                fg="white",
